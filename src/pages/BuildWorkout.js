...
const BuildWorkout = () => {
    ...
    const handleSubmit = async () => {
        if(searchTerm) {
            ...
            // Now, we want to add actual search functionality. Effectively we want to filter through the array of objects to filter out all objects that have values that correspond to the search term, and then put them in their own array.

            const specificExerciseSearches = exerciseSearchResults.filter((exercise) => exercise.bodyPart.toLowerCase().includes(searchTerm)
